...
class ButtonWidthIcon extends StatefulWidget {
  ...
  @override
  State<ButtonWidthIcon> createState() => _ButtonWidthIconState();
}

class _ButtonWidthIconState extends State<ButtonWidthIcon> {
              ...
              child: MouseRegion(
                ...
                child: AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    color: _getIconColor(isHovered, isPressed),
                  ),
                ),
              ),
            );
  ...
  Color _getIconColor(bool isHovered, bool isPressed) {
    if (widget.colorIcon.length > 1) {
      if (isHovered) {
        // Warna ketika hover
        return widget.colorIcon[1];
      } else if (isPressed) {
        // Warna ketika ditekan
        return widget.colorIcon[1];
      } else {
        // Warna normal
        return widget.colorIcon[0];
      }
    } else {
      return widget.colorIcon[0];
    }
